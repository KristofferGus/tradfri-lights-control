...
from mytypes import ConfigFile, DeviceConfig, Id, LampMessage, ModeState, RemoteRequest
...
class MyController:  # Seen as singleton
    ...
    async def publish_all_lights(self, message: LampMessage):
        ...
        gen = (self.mqtt.publish(topic=f"{PUBLISH_PREFIX}/{l['id']}/set", payload=data, qos=1) for l in self.lights)
